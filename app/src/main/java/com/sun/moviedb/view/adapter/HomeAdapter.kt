 ...
 */
class HomeAdapter(val onMoreClicked: (category: CategoryDTO) -> Unit,
        ...
        BaseRecyclerAdapter<CategoryDTO, ItemHomeMovieBinding>(object : DiffUtil.ItemCallback<CategoryDTO>() {
            ...
            override fun areItemsTheSame(oldItem: CategoryDTO, newItem: CategoryDTO) = oldItem.queryType == newItem.queryType
